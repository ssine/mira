...
test("native store events carry Unix seconds without a rollout timestamp envelope", () => {
  const started = { item_seq: "7", payload: { type: "event_msg", payload: { type: "task_started", turn_id: "native", started_at: 1788622585 } } };
  ...
  assert.equal(projectThreadActivity([started]).startedItemSeq, 7);
