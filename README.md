...
1.0.14 加入七日额度消耗参考线，并从会话历史恢复推理强度设置；同时包含大会话分块 fork 修复，
...
```sh
curl -fsSL https://raw.githubusercontent.com/ssine/mira/main/scripts/install.sh | sh -s -- --role node --server https://mira.example.com --version 1.0.14
```
